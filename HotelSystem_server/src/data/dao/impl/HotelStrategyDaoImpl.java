...
public class HotelStrategyDaoImpl implements HotelStrategyDao {
	...
	public ArrayList<HotelStrategyPO> getAll(String hotelId) {
		...
		try {
			ArrayList<HotelStrategyPO> hotelstrategy2 = (ArrayList<HotelStrategyPO>) hibernateUtil
					.getAll("hotelstrategypo", HotelStrategyPO.class);
			for (HotelStrategyPO strategyPO : hotelstrategy2) {
				if (strategyPO.getHotelID() != null && strategyPO.getHotelID().equals(hotelId)) {
